...
\begin{figure*}[!t]
    ...
    \caption{\textbf{Training curves for CNN and Bi-LSTM.\\} 
    \textbf{Top row (CNN, Kernel=12, Filters=32)}. The model converges quickly, with validation loss stabilizing around 0.43 and Spearman correlation reaching a plateau of approximately 0.577 by epoch 15.\\ 
    \textbf{Bottom row (Bi-LSTM, Hidden=64, Epochs=50)}. The validation loss decreases steadily, and the Spearman correlation achieves a superior peak of approximately 0.650 around epoch 45.}
